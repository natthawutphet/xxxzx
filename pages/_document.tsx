...
const urls = "https://www.service-ads.com";
  ...
  return (
    ...
    <Script
            ...
            src={`https://www.googletagmanager.com/gtag/js?id=G-76WMEE9M6S`}
          />
...
<meta name="twitter:card" content={`${urls}/img/logo.png`}/>


<meta property="og:image" content={`${urls}/img/logo.png`} />
...
<meta name="twitter:card" content={`${urls}/img/logo.png`} />
<meta name="twitter:image" content={`${urls}/img/logo.png`} />
<meta name="twitter:title" content="รับทำโฆษณาออนไลน์สายเทา" />
