...
import Reveiws from "./Home/reveiws";
...
<Head>
           ...
           <title>รับทำโฆษณาออนไลน์สายเทา ผู้เชี่ยวชาญด้านการตลาดบน Google, YouTube และ Facebook</title>
           <meta name="description" content="ทำโฆษณาเว็บไซต์ต่างๆด้วยทีมงานมือถือชีพ อัตราค่าบริการเพียงเดือนละ 9,900 บาทจบไม่มีค่าใช้จ่ายใดๆเพิ่มเติมทั้งสิ้น มีรีวิวจากลูกค้าจริงให้ชมไม่บิดไม่ทิ้งงานแน่นอน"/>
      ...
      <div className="page-banner home-banner">
        <div className="row align-items-center flex-wrap-reverse h-100">
          <div className="col-md-6 py-5 wow fadeInLeft">
            <h1 className="mb-4">รับทำโฆษณา Google Facebook สายเทา</h1>
        ...
        <div className="col-lg-4">
          <div className="card-service wow fadeInUp">
            ...
            <div className="body">
              ...
              <a href="https://lin.ee/JwrDPgA" className="btn btn-primary">พร้อมเริ่มแล้ว</a>
            </div>
          </div>
        </div>
        <div className="col-lg-4">
      ...
      <div className="row align-items-center">
        <div className="col-lg-6 py-3 wow fadeInUp">
         ...
         <p>รูปภาพทั้งหมดนี้เป็นส่วนหนึ่งในการทำงานของเราเท่านั้นนะครับ</p>
          ...
          <a href="https://lin.ee/JwrDPgA" className="btn btn-primary mt-3">ติดต่อสอบถาม</a>
        </div>
