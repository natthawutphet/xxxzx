      ...
      <div className="page-banner home-banner">
        <div className="row align-items-center flex-wrap-reverse h-100">
          <div className="col-md-6 py-5 wow fadeInLeft">
            ...
            <Link href="https://www.youtube.com/channel/UCMSh0LMC_RczXmJ6Qtxo4QA" className="btn btn-primary btn-split">Watch Video <div className="fab"><span className="mai-play"></span></div></Link>
          </div>
        ...
        <div className="col-lg-4">
          ...
          <Image src="/img/Facebook.png" alt="Facebook Ads" fill className="image" style={{ objectFit: 'cover' }} />
            ...
            <div className="body">
              ...
              <Link href="https://lin.ee/JwrDPgA" className="btn btn-primary">พร้อมเริ่มแล้ว</Link>
            </div>
          </div>
        </div>
        <div className="col-lg-4">
      ...
      <div className="row align-items-center">
        <div className="col-lg-6 py-3 wow fadeInUp">
         ...
         <p>รูปภาพทั้งหมดนี้เป็นส่วนหนึ่งในการทำงานของเราเท่านั้นนะครับ</p>
          ...
          <Link href="https://lin.ee/JwrDPgA" className="btn btn-primary mt-3">ติดต่อสอบถาม</Link>
        </div>
